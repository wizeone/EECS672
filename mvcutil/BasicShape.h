...
public:
	 ...
	 *  are parallel to one another, NULL is returned. These are the only error conditions.
	 ...
	 *         vector or a scalar multiple of the uEdge vector, NULL is returned.
	 ...
	 *  @return the BasicShape pointer, or NULL if invalid data was provided
	 */
	 ...
	 *  invalid specification), NULL is returned.
	 ...
	 *          vector VBO. NULL is returned if there are no vectors to be stored there.)
	 */
	 ...
	 *          coordinate VBO. NULL is returned if there are no texture coordinates.)
	 */
