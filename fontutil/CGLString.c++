...
CGLString::CGLString(const char *text, const CFont *font, int dim) :
	mText(NULL), mFont(font), mVertices(NULL), mVerticesForRender(NULL),
	mUVs(NULL), numCoordsInVerticesForRender(0), num2DCoords(0),
	mIndices(NULL), numIndices(0), mNumberOfQuads(0),
